...
const Footer = () => {
  return (
    <Container as="footer" fixed="bottom">
      <Container
        style={{ fontFamily: "'Inter', sans-serif", paddingBottom: "1em" }}
      >
          ...
          <Col md={4} className="contacts">
            ...
            <div className="contact-link-container">
              ...
              <a
                ...
                href="https://www.instagram.com/algocount/"
              >
                <FaInstagram size={24} style={{ padding: ".2em" }} />
              </a>
              ...
              <a
                ...
                href="https://www.youtube.com/channel/UCl3KEIPFFlY8rtKxI0m0xlA"
              >
                <FaYoutube size={24} style={{ padding: ".2em" }} />
              </a>
